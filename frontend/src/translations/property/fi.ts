const property = {
    ...
    compare: 'Vertaile',
    listView: 'Lista',
    compareView: 'Vertailu',
    noProspects: 'Ei vielä harkittavia kohteita',
    addProspect: 'Lisää kohde',
    ...
    deleteCharge: 'Poista vastike',
    chargeType: 'Vastikkeen tyyppi',
    startDate: 'Alkupäivä',
    endDate: 'Loppupäivä',
    ...
    chargeAmount: 'Summa',
    confirmDeleteCharge: 'Haluatko varmasti poistaa tämän vastikkeen?',
