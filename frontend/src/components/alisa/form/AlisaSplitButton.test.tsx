...
import AlisaSplitButton from './AlisaSplitButton';
import { AlisaSelectFieldItem } from './AlisaSelectField';

describe('AlisaSplitButton', () => {
  const mockItems: AlisaSelectFieldItem[] = [
    { id: 1, name: 'Action 1' },
    { id: 2, name: 'Action 2' },
    { id: 3, name: 'Action 3' },
  ];
