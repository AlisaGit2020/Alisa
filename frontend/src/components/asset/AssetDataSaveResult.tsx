import { DataSaveResult, DataSaveResultRow } from "@asset-types";
import { TFunction } from "i18next";
import Typography from "@mui/material/Typography";
import { Box, Chip, Stack, Tooltip } from "@mui/material";

interface AssetDataSaveResultProps {
  result: DataSaveResult;
  visible: boolean;
  t: TFunction;
}

function AssetDataSaveResult(props: AssetDataSaveResultProps) {
  if (!props.visible) {
    return null;
  }
  return (
...
export default AssetDataSaveResult;
