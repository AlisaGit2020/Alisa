...
import AssetLoadingProgress from "../AssetLoadingProgress";
import { useToast } from "../toast";
import { AxiosError } from "axios";
import { useFormValidation, FieldRules } from "../../../lib/useFormValidation";

interface AssetFormHandlerProps<T extends object> {
...
function AssetFormHandler<T extends object>(props: AssetFormHandlerProps<T>) {
