...
import { AssetSelectFieldItem } from "./AssetSelectField.tsx";
import { Box, Stack } from "@mui/material";
import Typography from "@mui/material/Typography";

function AssetSplitButton(props: {
  label?: string;
  value: number;
  ...
  const handleSelect = (selelctedItem: AssetSelectFieldItem) => {
...
export default AssetSplitButton;
