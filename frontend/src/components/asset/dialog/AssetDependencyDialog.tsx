...
import { DeleteValidationResult, DependencyType } from "@asset-types";

interface AssetDependencyDialogProps {
  open: boolean;
...
function AssetDependencyDialog({
  open,
  validationResult,
  onClose,
  onConfirmDelete,
}: AssetDependencyDialogProps) {
...
export default AssetDependencyDialog;
