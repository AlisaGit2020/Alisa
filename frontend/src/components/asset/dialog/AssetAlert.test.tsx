...
describe('AssetAlert', () => {
  it('renders message', () => {
    renderWithProviders(
      <AssetAlert severity="success" content="Test Message" />
    );
  ...
  it('renders with success severity', () => {
    const { container } = renderWithProviders(
      <AssetAlert severity="success" content="Success Message" />
    );
  ...
  it('renders with error severity', () => {
    const { container } = renderWithProviders(
      <AssetAlert severity="error" content="Error Message" />
    );
  ...
  it('renders with warning severity', () => {
    const { container } = renderWithProviders(
      <AssetAlert severity="warning" content="Warning Message" />
    );
  ...
  it('renders with info severity', () => {
    const { container } = renderWithProviders(
      <AssetAlert severity="info" content="Info Message" />
    );
  ...
  it('does not render when content is empty', () => {
    const { container } = renderWithProviders(
      <AssetAlert severity="success" content="" />
    );
  ...
  it('renders array of messages', () => {
    renderWithProviders(
      <AssetAlert severity="error" content={['Error 1', 'Error 2', 'Error 3']} />
    );
