...
import AssetConfirmDialog from "../dialog/AssetConfirmDialog.tsx";
import { useToast } from "../toast";
import DataService from "@asset-lib/data-service.ts";
import AssetDataTableActionButtons, {
  AssetDataTableAddButton,
} from "./AssetDataTableActionButtons.tsx";
import AssetDataTableSelectRow, {
  AssetDataTableSelectHeaderRow,
} from "./AssetDataTableSelectRow.tsx";
import {
  TransactionType,
  TransactionTypeName,
...
function AssetDataTable<T extends { id: number }>(props: {
  t: TFunction;
  fields: AssetDataTableField<T>[];
  ...
  const calculateSum = (field: AssetDataTableField<T>): number => {
